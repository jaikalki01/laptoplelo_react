  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12 text-gray-800">
      <h1 className="text-4xl font-bold text-[rgb(155,135,245)] mb-6">
        Shipping Policy – LaptopLelo.in
      </h1>
      <p className="mb-6 text-sm text-gray-600">Last updated: May 6, 2025</p>
      <p className="mb-6">
        LaptopLelo.in is committed to ensuring a smooth and reliable shipping experience for all customers. This policy outlines the terms related to product shipping, order processing, tracking, and timelines.
      </p>
      ...
      <section className="mb-6 bg-gray-50 p-4 rounded-md shadow-md">
        ...
        <p>
          We deliver across India to all serviceable pin codes. Orders may be fulfilled and shipped directly by the vendors registered on LaptopLelo.in.
        </p>
      </section>
      ...
      <section className="mb-6 bg-gray-50 p-4 rounded-md shadow-md">
        ...
        <p>
          Once your order is dispatched, you will receive a shipping confirmation email or SMS with the tracking number and courier details. You can also track your order status via your LaptopLelo.in account dashboard.
        </p>
      </section>
      ...
      <section className="mb-6 bg-gray-100 p-4 rounded-md shadow-md">
        ...
        <p>
          LaptopLelo.in and its vendors are not liable for delays caused by force majeure, courier partner issues, or incorrect shipping information provided by the customer. In case of delivery failure, the product may be returned to the vendor, and additional charges may apply for re-shipment.
        </p>
      </section>
      ...
      <section className="mb-6 bg-gray-50 p-4 rounded-md shadow-md">
        ...
        <p>
          Products are securely packaged to prevent damage during transit. Please inspect the package upon delivery. If you find any visible damage, report it immediately to the delivery personnel and to us at <a href="mailto:support@laptoplelo.in" className="text-[rgb(155,135,245)] underline">support@laptoplelo.in</a>.
        </p>
      </section>
