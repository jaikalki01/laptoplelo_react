  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12 text-gray-800">
      <h1 className="text-4xl font-bold text-[rgb(155,135,245)] mb-6">
        Terms and Conditions – LaptopLelo.in
      </h1>
      ...
      <section className="bg-gray-50 p-6 rounded-lg mb-6">
        ...
        <ul className="list-disc list-inside space-y-1">
          <li><strong>Platform:</strong> Refers to LaptopLelo.in.</li>
          <li><strong>Vendor:</strong> Any person or entity registered to sell products via LaptopLelo.in.</li>
      ...
      <section className="bg-gray-50 p-6 rounded-lg mb-6">
        ...
        <ul className="list-disc list-inside space-y-1">
          <li>LaptopLelo.in provides a marketplace for users to purchase and vendors to sell laptops and accessories.</li>
      ...
      <section className="bg-gray-50 p-6 rounded-lg mb-6">
        ...
        <ul className="list-disc list-inside space-y-1">
          ...
          <li>LaptopLelo.in may withhold payments to vendors until order delivery is confirmed.</li>
      ...
      <section className="bg-gray-50 p-6 rounded-lg mb-6">
        ...
        <ul className="list-disc list-inside space-y-1">
          <li>All content on LaptopLelo.in, including logos, images, and text, is owned by or licensed to LaptopLelo.in.</li>
      ...
      <section className="bg-gray-50 p-6 rounded-lg mb-6">
        ...
        <ul className="list-disc list-inside space-y-1">
          <li>LaptopLelo.in is a marketplace and does not take responsibility for the products sold.</li>
